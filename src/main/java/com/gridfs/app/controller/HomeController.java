...
public class HomeController {
	...
	@RequestMapping(value = "/visualization/{id}")
	...
	public String multiFileUpload(@ModelAttribute UploadForm form, RedirectAttributes redirectAttributes) {
		...
		if (StringUtils.isEmpty(uploadedFileName)) {
			redirectAttributes.addFlashAttribute("message", "Selecione um arquivo para upload");
		} else {
			redirectAttributes.addFlashAttribute("message", "Arquivo '" + uploadedFileName + "' registrado com sucesso");
		}
